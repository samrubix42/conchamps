...
<head>
    ...
    <title>{{ $meta_title ?? $title ?? 'Admin' }} | Concrete Champs</title>
    <meta name="description" content="{{ $meta_description ?? 'Administration area for Concrete Champs site management and configuration.' }}">
