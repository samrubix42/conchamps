...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-slate-500">
            Manage Project categories, status and visibility.
        </p>
    </div>
    ...
    <div class="space-y-4">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-slate-200 text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100 bg-white">
                        @forelse($this->getCategoriesProperty() as $category)
        ...
        <div class="mt-3 flex justify-end">
            {{ $this->getCategoriesProperty()->links() }}
        </div>

        <!-- Modal stays unchanged -->
        @include('admin.category.category-list.category-modal')
        @include('admin.category.category-list.delete')
