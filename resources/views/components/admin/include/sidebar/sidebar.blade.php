        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1.5">
            ...
            @foreach ($menu as $item)
                ...
                <div x-data="{ open: {{ $initialOpen }} }">
                    ...
                    @if($hasChildren)
                        ...
                        <div x-show="open"
                            ...
                            @foreach ($item['children'] as $child)
                                <a @if($child['uri'] !== '/admin/projects' && !str_starts_with($child['uri'], '/admin/careers')) wire:navigate @endif href="{{ $child['uri'] }}"
                    ...
                    @else
                        <!-- Single Item -->
                        <a @if($item['uri'] !== '/admin/projects' && !str_starts_with($item['uri'], '/admin/careers')) wire:navigate @endif href="{{ $item['uri'] }}"
