    ...
    <div class=" bg-[#272944] backdrop-blur">
        <nav class="container-custom h-16 md:h-[72px] grid grid-cols-[1fr_auto] lg:grid-cols-[220px_1fr_190px] items-center gap-4">
            ...
            <div class="flex items-center justify-end gap-2">
                <a wire:navigate href="{{route('contact')}}" class="hidden lg:inline-flex btn-primary !bg-[#3c38a1] shadow shadow-md !text-white !font-semibold !rounded-lg !px-5 !py-2.5 !text-xs uppercase !tracking-[0.08em]">
                    Contact Now
                </a>
