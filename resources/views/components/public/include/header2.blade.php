...
<header
    ...
    <div class="hidden lg:block border-b border-slate-200/80 bg-white/95 backdrop-blur">
    ...
    <div class="border-b border-slate-200 bg-white/95 backdrop-blur">
        <nav class="container-custom h-16 md:h-[72px] grid grid-cols-[1fr_auto] lg:grid-cols-[220px_1fr_190px] items-center gap-4">
            <a href="{{ url('/') }}" class="relative z-[120] inline-flex items-center">
                <img src="{{ asset('Concrete-Champs-white.png') }}" alt="Concrete Champs" class="h-8 sm:h-9 md:h-10" />
            </a>

            <div class="hidden lg:flex items-center justify-center gap-2">
                <a href="#" class="px-4 py-2 rounded-lg text-[15px] font-medium text-slate-900 hover:text-secondary hover:bg-slate-100 transition-colors">Home</a>
                <a href="#" class="px-4 py-2 rounded-lg text-[15px] font-medium text-slate-700 hover:text-secondary hover:bg-slate-100 transition-colors">About</a>
                <a href="#" class="px-4 py-2 rounded-lg text-[15px] font-medium text-slate-700 hover:text-secondary hover:bg-slate-100 transition-colors">Projects</a>
                <a href="#" class="px-4 py-2 rounded-lg text-[15px] font-medium text-slate-700 hover:text-secondary hover:bg-slate-100 transition-colors">Services</a>
                <a href="#" class="px-4 py-2 rounded-lg text-[15px] font-medium text-slate-700 hover:text-secondary hover:bg-slate-100 transition-colors">Contact</a>
            </div>

            <div class="flex items-center justify-end gap-2">
                <button class="hidden lg:inline-flex btn-primary !rounded-lg !px-5 !py-2.5 !text-xs uppercase !tracking-[0.08em]">
                    Contact Now
                </button>

                <button
                    @click="mobileMenuOpen = !mobileMenuOpen"
                    class="lg:hidden relative z-[120] inline-flex h-10 w-10 items-center justify-center rounded-lg border border-slate-200 bg-slate-50 text-slate-900"
...
>
        ...
        <div class="flex flex-col gap-2 mt-2">
            ...
            <a href="#" @click="mobileMenuOpen = false"
               class="flex justify-between items-center px-4 py-4 rounded-xl text-xl font-headline uppercase tracking-wide hover:bg-gray-100 transition">
                Home
                <i class="ri-arrow-right-up-line text-secondary"></i>
            </a>
    ...
    <div class="px-6 py-4 border-t border-gray-200 flex justify-between items-center text-sm">
        ...
        <div class="flex gap-4 text-lg">
            <a href="#" class="hover:text-secondary"><i class="ri-linkedin-fill"></i></a>
            <a href="#" class="hover:text-secondary"><i class="ri-instagram-line"></i></a>
            <a href="#" class="hover:text-secondary"><i class="ri-youtube-fill"></i></a>
        </div>
    </div>
